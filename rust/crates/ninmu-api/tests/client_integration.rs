...
async fn send_message_posts_json_and_parses_response() {
    ...
    assert_eq!(
        ...
        Some("claude-code-20250219,prompt-caching-scope-2026-01-05,prompt-caching-2024-07-31,extended-cache-ttl-2025-04-11")
    );
...
async fn send_message_applies_request_profile_and_records_telemetry() {
    ...
    assert_eq!(
        request.headers.get("anthropic-beta").map(String::as_str),
        Some("claude-code-20250219,prompt-caching-scope-2026-01-05,prompt-caching-2024-07-31,extended-cache-ttl-2025-04-11,tools-2026-04-01")
    );
    assert_eq!(
        request.headers.get("user-agent").map(String::as_str),
